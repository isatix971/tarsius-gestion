                    ...
                    <div class="panel-body">
                        <form class="form-horizontal form-border" method="post" action="<?php echo base_url(); ?>index.php/main/?fun=almacenarPedido">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type='text' required="" placeholder='Nombre / Razon social' id='nomEmpresa' name='nomEmpresa' class='form-control ui-autocomplete-input' autocomplete='on' />
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" placeholder="Ingrese Cantidad" id="b20" name="b20" required="" class="form-control ">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Dispensador Plastico</label>
                                <div class="col-sm-6">
                                    <input type="number" placeholder="Ingrese Cantidad" id="dispensador" name="dispensador" required="" class="form-control ">
                                </div>
                            </div>
                            <div class="form-group">
...
<script >
    ...
    $(document).ready(function () {
       ...
       document.getElementById("nomEmpresa").onchange = function() {
        alert("dgsfg");
    };
