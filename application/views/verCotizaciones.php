...
//                            echo "</form>";
                            ...
                            echo "<button onClick='crearCotizacion("; echo $row['id']; echo $row['nombre']; echo ")' type='button' class='btn btn-primary'>Enviar</button>";
...
<script>
    ...
    function crearCotizacion(id,nombre) {
